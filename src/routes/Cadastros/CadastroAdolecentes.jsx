...
const CadastroAdolescentes = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      setMessage(`${newUser.name} foi incluído(a) com sucesso!`);
      setNewUser({ name: ''});
  ...
  const handleDeleteUser = async (userId, userName) => {
    try {
      ...
      setMessage(`${userName} foi excluído(a) com sucesso!`);
...
export default CadastroAdolescentes;
