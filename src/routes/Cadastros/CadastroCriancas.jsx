  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Conta a quantidade de vezes que o campo booleano é true (no campo presença)
     //   const trueCount = usersData.filter((user) => user.presença === true)
       //   .length;
        //setTrueCount(trueCount); 
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      const docRef = await addDoc(usersRef, {
        ...newUser,
        data: Timestamp.fromDate(new Date()), // Adiciona a data atual
        presença: false, // Assume que a presença é false por padrão
      });
...
export default CadastroCriancas;
 */
