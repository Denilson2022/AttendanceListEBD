...
const DatasChamadasAdolescentesPorData = ({ date }) => {
...
const RevistaKeys = Object.keys(userData).filter(
  (key) => key.startsWith('revista_') && key.includes('2023-12-02')
);
...
export default DatasChamadasAdolescentesPorData;
 */

// DatasChamadasAdolescentesPorData.jsx
import React, { useState, useEffect } from 'react';
import { collection, getDocs, getFirestore } from 'firebase/firestore';
import FirebaseConfig from '../../../service/firebase';
import { initializeApp } from 'firebase/app';
...
const DatasChamadasAdolescentesPorData = () => {
  const [users, setUsers] = useState([]);
