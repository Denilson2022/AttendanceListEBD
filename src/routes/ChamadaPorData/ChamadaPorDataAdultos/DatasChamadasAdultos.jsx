...
import ChamadasAdultosPorData from './ChamadaPorDataAdultos';
      ...
      <Routes>
        {Object.entries(datesByMonth).map(([monthYear, dates]) => (
          <Route
            ...
            element={<ChamadasAdultosPorData dates={dates} />}
          />
        ))}
        <Route
          path="/"
...
export default DatasChamadasAdultos;
