...
import ChamadasCriancasPorData from './ChamadaPorDataCriancas';
      ...
      <Routes>
        {Object.entries(datesByMonth).map(([monthYear, dates]) => (
          <Route
            ...
            element={<ChamadasCriancasPorData dates={dates} />}
          />
        ))}
        <Route
          path="/"
...
export default DatasChamadasCriancas;
