...
import ChamadasJovensPorData from './ChamadaPorDataJovens';
      ...
      <Routes>
        {Object.entries(datesByMonth).map(([monthYear, dates]) => (
          <Route
            ...
            element={<ChamadasJovensPorData dates={dates} />}
    J     />
        ))}
        <Route
          path="/"
...
export default DatasChamadasJovens